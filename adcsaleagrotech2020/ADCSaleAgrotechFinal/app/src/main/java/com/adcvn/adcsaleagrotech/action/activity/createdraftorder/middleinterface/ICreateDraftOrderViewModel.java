package com.adcvn.adcsaleagrotech.action.activity.createdraftorder.middleinterface;
...
public interface ICreateDraftOrderViewModel {
    ...
    void callApiSalesOrderAction(boolean receiveMoney, String deliveryDate, double totalAmount);
}
