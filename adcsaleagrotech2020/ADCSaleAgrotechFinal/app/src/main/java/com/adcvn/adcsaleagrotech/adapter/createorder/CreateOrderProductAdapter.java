package com.adcvn.adcsaleagrotech.adapter.createorder;
...
public class CreateOrderProductAdapter extends RecyclerView.Adapter<CreateOrderProductAdapter.RecyclerViewHolder> {
    private Context context;
    private List<ProductDetail> productsOrder;
    private CreateOrderActivity createOrderActivity;
    public CreateOrderProductAdapter(CreateOrderActivity createOrderActivity, Context context, List<ProductDetail> productsOrder) {
    ...
    @NonNull
    @Override
    public CreateOrderProductAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.ivRemoveProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(createOrderActivity != null) {
                    createOrderActivity.updateListProduct();
                }
            }
        });
            ...
            public void afterTextChanged(Editable s) {
                if(!edtActualValueBefore .equals(s.toString())) {
                    if(s.toString().trim().length() > 0){
                        ...
                        holder.edtQuantityProduct.setText(Common.formatNumber(numberInput));
                        if(createOrderActivity != null){
                            createOrderActivity.updateListProduct();
                        }
                    }else{
