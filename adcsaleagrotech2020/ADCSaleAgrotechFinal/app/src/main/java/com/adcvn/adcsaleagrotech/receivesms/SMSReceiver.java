package com.adcvn.adcsaleagrotech.receivesms;
        ...
        if (SmsRetriever.SMS_RETRIEVED_ACTION.equals(intent.getAction())) {
            ...
            switch (status.getStatusCode()) {
                case CommonStatusCodes.SUCCESS:
                    ...
                    String removeHashCode = message.substring(0,message.length()-12);
                    String otpSMS = removeHashCode.substring(removeHashCode.length()-6);
                    if(message.contains("ADC_GROUP")) {
                        Intent intentSMS = new Intent("SMS_INTENT");
                        intentSMS.putExtra("SMS_CONTENT",otpSMS);
