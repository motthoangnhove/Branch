...
import com.adcvn.adcsaleagrotech.adapter.choose.ThreeLabelChooseType2Adapter;
...
public class ChooseProductDialog extends DialogFragment{
    ...
    private ThreeLabelChooseType2Adapter rvListSelectThreeLabelAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.dialog_full_theme);
    ...
    private void initView(View view) {
        ...
        rvListSelectThreeLabelAdapter = new ThreeLabelChooseType2Adapter(context, activity, dialog, keyChoose, listSelectThreeLabel);
                    ...
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                            ...
                            if (event == null || !event.isShiftPressed()) {
                                ...
                                rvListSelectThreeLabelAdapter.getFilter().filter(searchText);
