...
public class ReceivableFutureAdapter extends BaseAdapter<ReceivableHeaderNowViewHodler> {

    public ReceivableFutureAdapter(Context context, SectionManager sectionManager, boolean isHeaderVisible, boolean isHeaderPinned, List<ReceivableDetail> receivableList, String header, int count) {
        super(context, sectionManager, isHeaderVisible, isHeaderPinned, receivableList, header, count);
        Log.d("LeCo", "ReceivableFutureAdapter: " + receivableList.size());
        this.type = 2;
    ...
    public BaseAdapter getCopy() {
        Log.d("LeCo", "ReceivableFutureAdapter getCopy(): " + receivableList.size());
        ReceivableFutureAdapter copy = new ReceivableFutureAdapter(context, sectionManager, isHeaderVisible(), isHeaderPinned(), receivableList, header, count);
    ...
    public BaseAdapter getNext() {
        Log.d("LeCo", "ReceivableFutureAdapter getNext(): " + receivableList.size());
        return new ReceivableFutureAdapter(context, sectionManager, isHeaderVisible(), isHeaderPinned(), receivableList, header, count);
    }
