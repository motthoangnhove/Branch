package com.adcvn.adcsaleagrotech.action.activity.createdraftorder.viewmodel;
...
public class CreateDraftOrderViewModel extends ViewModel implements ICreateDraftOrderViewModel, IOMEmployeeList, IOMCustomerList, IMisaCustomerDebtCheck, IPriceListGet, ISalesOrderAction
    {
    ...
    public CreateDraftOrderViewModel() {
        ...
        @Override
        public void callApiSalesOrderAction(boolean receiveMoney, String deliveryDate, double totalAmount){
        ...
        String lineOrderDetail = ToJsonString.getJSONList(listProductChooseObject,
                ...
                "getVatRate");
        SalesOrderActionPost salesOrderActionPost = new SalesOrderActionPost("604CD4B2-AE70-4819-9C42-300922F1482D", totalAmount, employeeId, contactName, contactPhone, employeeId, customerId, deliveryDateTranslate, isReceiveDelivery, lineOrderDetail, organizationId, paymentTermId, employeeId, userId, "");
