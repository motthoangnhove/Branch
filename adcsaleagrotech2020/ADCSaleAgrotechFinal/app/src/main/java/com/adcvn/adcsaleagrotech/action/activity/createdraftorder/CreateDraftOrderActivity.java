package com.adcvn.adcsaleagrotech.action.activity.createdraftorder;
...
import com.adcvn.adcsaleagrotech.action.activity.createdraftorder.middleinterface.ICreateDraftOrderViewModel;
import com.adcvn.adcsaleagrotech.action.activity.createdraftorder.viewmodel.CreateDraftOrderViewModel;
import com.adcvn.adcsaleagrotech.adapter.createorderdraft.CreateCraftOrderProductAdapter;
...
import com.adcvn.adcsaleagrotech.databinding.ActivityCreateDraftOrderBinding;
...
public class CreateDraftOrderActivity extends BaseActivity implements ISelectTwoLabelConfirm, ISelectThreeLabelConfirm {
    // khởi tạo live data và observer màn hình
    private ActivityCreateDraftOrderBinding binding;
    private ICreateDraftOrderViewModel iViewModel;
    ...
    private CreateCraftOrderProductAdapter productOrderAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_create_draft_order);
        Intent intent = getIntent();
        salesOrder = getIntent().getParcelableExtra("salesOrder");
        binding.setLifecycleOwner(this);
        iViewModel = ViewModelProviders.of(this).get(CreateDraftOrderViewModel.class);
        iViewModel.setInitContext(context, fm);
        iViewModel.setSalesOrder(salesOrder);
        binding.setCreateCraftOrder(iViewModel);
        initView();
        initEvent();
        initData();
    ...
    private void initView() {
        ...
        productOrderAdapter = new CreateCraftOrderProductAdapter(this, context, productChoose);
    ...
    private void initEvent() {
        ...
        tvChooseDateDeliveryOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SystemDatePickerDialog.showCalendar(CreateDraftOrderActivity.this, tvChooseDateDeliveryOrder, "Ngày giao hàng");
            }
        });
        ...
        btnCreateOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (omEmployeeChoose == null) {
                    ...
                    iViewModel.callApiSalesOrderAction(receiveMoney, tvChooseDateDeliveryOrder.getText().toString(), totalAmount);
                }
            }
        });
    }
    ...
    private void onObserverDataChange(ActivityCreateDraftOrderBinding binding) {

        //nhận dữ liệu thông tin chi tiết đơn hàng
        binding.getCreateCraftOrder().salesOrderData().observe(this, new Observer<SalesOrder>() {
            @Override
        ...
        binding.getCreateCraftOrder().orderTypeDetailData().observe(this, new Observer<OrderTypeDetail>() {
            @Override
        ...
        binding.getCreateCraftOrder().oMEmployeeListResultData().observe(this, new Observer<OMEmployeeListResult>() {
            @Override
        ...
        binding.getCreateCraftOrder().employeeChooseData().observe(this, new Observer<OMEmployee>() {
            @Override
        ...
        binding.getCreateCraftOrder().oMCustomerListResultData().observe(this, new Observer<OMCustomerListResult>() {
            @Override
        ...
        binding.getCreateCraftOrder().customerChooseData().observe(this, new Observer<OMCustomer>() {
            @Override
        ...
        binding.getCreateCraftOrder().misaCustomerDebtCheckResultData().observe(this, new Observer<MisaCustomerDebtCheckResult>() {
            @Override
        ...
        binding.getCreateCraftOrder().priceListGetResultData().observe(this, new Observer<PriceListGetResult>() {
            @Override
        ...
        binding.getCreateCraftOrder().productChooseData().observe(this, new Observer<ArrayList<ProductDetail>>() {
            @Override
            public void onChanged(ArrayList<ProductDetail> productChooseData) {
            }
        });

        binding.getCreateCraftOrder().salesOrderActionResultData().observe(this, new Observer<SalesOrderActionResult>() {
            @Override
